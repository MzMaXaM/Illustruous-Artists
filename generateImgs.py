...
positive_prompt = "masterpiece, 4k, high quality, artist: Eigaka. 1girl, solo, Sakura, pink short hair, green eyes, forehead protector, blushing, looking at viewer, smiling, white dress, green background, gradient background"
negative_prompt = "worst quality, low quality, text, censored, blurry, (watermark), artist signature, artist name"
...
<body>
    ...
    <div class="prompt-container">
        <div class="prompt positive-prompt">
            <strong>Positive Prompt:</strong> {positive_prompt}
        </div>
        <div class="prompt negative-prompt">
            <strong>Negative Prompt:</strong> {negative_prompt}
        </div>
    </div>
...
print('index.html and combinations.html have been created')